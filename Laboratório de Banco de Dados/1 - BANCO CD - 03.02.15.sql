...
SELECT ASCII('D')+ ASCII('a') + ASCII('n') + ASCII('i') + ASCII('e') + ASCII('l');


SELECT UPPER(nome_musica), nome_musica
FROM musica;


SELECT UPPER(nome_gravadora), endereco, LOWER(url)
FROM gravadora;


SELECT *
FROM musica
WHERE LEN(nome_musica) < 15;


SELECT SUBSTRING('FATEC ZONA SUL', 1, 5);