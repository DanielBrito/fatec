...
' -> DESAFIO: Quais as gravadoras e CDs (nome) com preço que tenham 
     o preço maior que a média dos preços por gravadora.'
...
' Apresentar a gravadora do CD 2 e seus respectivos CDs 
  que tenha(m) os preços menores que o preço do CD 5. '
...
' Apresentar a música que contém "MENINOS. '
...
'Quais os CDs com preço menor que R$10,00 e os CDs com preço maior que R$20,00?'
...
'Apresente as músicas do CD1 e as músicas que não estejam nos CDs 1 e 2'
...
'Apresente as músicas do CD1 e as músicas que não estejam nos CDs pares'
...
'Quais os CDs que têm gravadora?'
...
INTERSECT
	...
	FROM gravadora;
			...
			' - DESAFIO -
Apresente os autores das faixas pares do CD1 e os mesmos que apareçam nas faixa ímpares do CD2. '
...
'D1) Apresente as músicas (código e nome) do CD 1'
...
'D2) Apresente as músicas (código e nome) do CD 1 (+ código e nome)'
...
'D3) Apresente as músicas (código e nome) do CD 1 (+ código e nome) e os autores (código e nome)'
...
'D4) Apresente as músicas (código e nome) do CD 1 (+ código e nome) e os autores (código e nome)'
     'de sua gravadora (código e nome)'


'D5) Quais as músicas (código e nome) dos autores ímpares'


'D6) Quais autores (código e nome) das músicas pares?'


'D7) Cadastrar 3 músicas e 3 autores. Apresentar as músicas que não possuem autores'
     'e os autores que não possuem música.'


'D8) Quais as músicas que não estão gravadas?'
...
' PASSAGEM DE PARÂMETRO DE ENTRADA'
...
/* Criar uma sp onde -> Informando o código do cd deverá 
apresentar os nomes das músicas e dos respectivos autores */
