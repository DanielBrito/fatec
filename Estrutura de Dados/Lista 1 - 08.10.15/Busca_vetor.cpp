...
*/
int x[n], i= -1;
void inserir_valor(int valor){//inicio
     i++;
     x[i] = valor;           }//fim inserir

int procura_indice(int valor) {//inicio
    ...
    return -1;                }// fim procura

void imprimir(){// inicio
  system("cls");
...
cout << "Valor existente no indice " << 
                        procura_indice(valor) << endl;
else
cout << "Valor inexistente na estrutra!" << endl;
getch();       }// fim op ==2
                              
else if (op==3) { imprimir();}// fim op==3
     }//fim while            
         }// fim void menu

int main() {executa_menu(); return 0;}
